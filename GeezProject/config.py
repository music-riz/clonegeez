...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "VirtualMusicChannel")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "GroupVirtualMusic")
PROJECT_NAME = getenv("PROJECT_NAME", "Virtual Project")
OWNER = getenv("OWNER", "@Bukan_guudlooking")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/widodo01/clonegezz")
